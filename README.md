...
| Work items | AI Part Lookup Assistant |
| Source provider | GitHub |
| Repository | https://github.com/csdmichael/ai-part-lookup-assistant |
...
| `GET` | `/api/assistants` | List assistants, optionally filtered by `?status=` |
| `POST` | `/api/assistants` | Create an assistant |
| `GET` | `/api/assistants/{id}` | Fetch one assistant |
| `PATCH` | `/api/assistants/{id}` | Update title, reference, status, priority |
...
- `requirements` — [ai-part-lookup-assistant-requirements.md](https://github.com/csdmichael/ai-part-lookup-assistant/blob/main/docs/intake/requirements/ai-part-lookup-assistant-requirements.md)
